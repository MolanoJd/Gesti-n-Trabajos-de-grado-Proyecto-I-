...
public class clsEstudiante extends clsUsuario {
    ...
    public clsEstudiante(Integer id, String email, String password, String usuario_nombres, String usuario_apellidos, int usuario_codigo, String matricula, String carrera) {
