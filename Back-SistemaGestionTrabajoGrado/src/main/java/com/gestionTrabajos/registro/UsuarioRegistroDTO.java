...
public class UsuarioRegistroDTO {
	...
	public UsuarioRegistroDTO(Integer id, String email, String password, String usuario_nombres, String usuario_apellidos, int usuario_codigo, List<clsAnteproyecto> anteproyectos) {
		this.id = id;
		this.email = email;
		this.password = password;
		this.usuario_nombres = usuario_nombres;
